package dev.imlukas.hoarderplugin.utils.command.impl;

import dev.imlukas.hoarderplugin.HoarderPlugin;
import dev.imlukas.hoarderplugin.utils.command.BaseCommand;
import dev.imlukas.hoarderplugin.utils.command.SimpleCommand;
import dev.imlukas.hoarderplugin.utils.command.comparison.ComparisonResult;
...
public class CommandManager {
    ...
    private final HoarderPlugin main;

    public CommandManager(HoarderPlugin main) {
        this.main = main;
    }
